...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
        ...
        %>
		<title><%=addressName%>-IPD服务列表 </title>
					...
					<td valign="top">
						<div class="table_right">
							<div class="moudle_div">
								...
								<form action="${ctx}/ipdserver/ipdServerList.action" name="listForm" id="listForm" method="post" >
									<div class="seach_div">
										Ipd编号:
										<input name="ipdId" id="ipdId" type="text" size="10" value="${model.ipdId}"/>
										&nbsp;&nbsp;
										所属服务器:
										...
										&nbsp;&nbsp;
										<input name="input" type="button" value="重 置" class="btn_w66_write1" onclick="window.location.href='${ctx}/ipdserver/ipdServerList.action'" />
									</div>
									<div class="div_content">
										<table width="100%" border="0" cellspacing="0" cellpadding="0">
											<tr>
												<td width="100%" height="100%" valign="top" colspan="2">
													<div id="biaoge"><jsp:include page="ipdServerListTable.jsp"/></div>
												</td>
											</tr>
										</table>
									</div>
