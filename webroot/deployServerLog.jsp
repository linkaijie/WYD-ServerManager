...
<script type="text/javascript">
        ...
        $.ajax({
            type : 'POST',
            url : "common/getDeployServerList.action",
		...
		<table width="100%" border="0" cellspacing="0" cellpadding="0">
            <td>
                <table width="100%" class="bought-table">
                    ...
                    <c:if test="${sessionScope.deployBeanList ne null}">
                        <c:forEach items="${sessionScope.deployBeanList}" var="data" varStatus="status">
                            <tr <c:choose>
                            ...
                            <c:otherwise>class="even"</c:otherwise>
                                ...
                                <td id = "status_${data.id}" name = "accList" align="center"><forn style = "color:blue">部署中</forn></td>
                            </tr>
                        </c:forEach>
                        <tr>
                        <span align="center">
