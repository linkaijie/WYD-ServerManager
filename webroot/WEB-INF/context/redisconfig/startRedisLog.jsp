...
<title>redis开启日志</title>
<script type="text/javascript">
        myInterval = setInterval(function() {
        $.ajax({
            type : 'POST',
            url : "common/getOperateList.action",
            data: {sessionType:"startRedisVo"},
...
<div id="hld">
	<div class="row-fluid">
		...
		<table width="100%" border="0" cellspacing="0" cellpadding="0">
            <td>
                <table width="100%" class="bought-table">
                    <thead>
                        <tr>
                            <th>id</th>
                            <th>名称</th>
                    ...
                    <tbody width="100%" class=" success-order">
                    <c:if test="${sessionScope.startRedisList ne null}">
                        <c:forEach items="${sessionScope.startRedisList}" var="data" varStatus="status">
                            <tr <c:choose>
                            ...
                            <c:otherwise>class="even"</c:otherwise>
                                ...
                                <td id = "status_${data.id}" name = "accList" align="center"><forn style = "color:blue">开启中</forn></td>
                            </tr>
                        </c:forEach>
                        <tr>
                        <span align="center">
