...
<script type="text/javascript" src="${ctx}/scripts/server/worldServer.js"></script>
		...
		<thead>
			<tr class="toolbar skin-gray">
				<td colspan="7">
					...
					<a name = "acc" href="javascript:synVersion();" class="toolbtn2">同步Version</a>
				...
				<table class="bought-table">
					<thead>
						<tr>
							...
							<th>状态</th>
							<th>是否已部署</th>
							<th><a name = "acc" href="javascript:input();">添加</a>---<a name = "acc" href="javascript:inputCreate();">添加W</a>---<a name = "acc" href="javascript:worldAndDispatchAdd();">添加WD</a></th>
						</tr>
					</thead>
