...
<script type="text/javascript">
        ...
        $.ajax({
            type : 'POST',
            url : "common/getUpdateRestartList.action",
		...
		<table width="100%" border="0" cellspacing="0" cellpadding="0">
            <td>
                <table class="bought-table" width="100%">
                    ...
                    <c:if test="${sessionScope.updateRestartBeanList ne null}">
                        <c:forEach items="${sessionScope.updateRestartBeanList}" var="data" varStatus="status">
                            <tr <c:choose>
