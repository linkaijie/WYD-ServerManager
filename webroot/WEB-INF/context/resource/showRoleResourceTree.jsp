...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<script type="text/javascript" src="${ctx}/scripts/loadTree/roleResourceTreeCheck.js"></script>
...
function select_terminal(){
	...
	$.ajax({
			  url: ctx+"/resource/saveResourcesTree.action?resourcesId="+resourceId+"&roleCheckId="+parEle,
			  cache: false,
