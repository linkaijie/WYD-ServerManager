...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<script type="text/javascript" src="${ctx}/scripts/loadTree/userRoleTreeCheck.js"></script>
...
function select_terminal(){
	...
	$.ajax({
			  url: ctx+"/role/saveRoleUserTree.action?roleId="+roleId+"&roleUserCheckId="+parEle,
			  cache: false,
							...
							<div class="moudle_div">
								<div class="sidebar_title">
									<div class="sidebar_title_border">
										<s:text name="StaffAssignments"></s:text>
									</div>
								</div>
