...
//  			},
//  			 timeout : 3000,
//              url: "accountserver/showDeployResult.action",
//          });
	});
    ...
    function closreload(url)
    {
    	...
    	//    P.reload(D.J.dialog.infrm['newForm'],ctx+"/operateLog/operatingLogList.action",true);
         ...
         E.location.href=ctx+"/accountserver/accountServerList.action"; //此句为关闭此子窗口同时父窗口跳转到  ListData.aspx 页面
         P.cancel();
    }
</script>
</head>
