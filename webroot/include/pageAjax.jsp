...
<div id="tnt_pagination">
	<%
	    if (pageInfoNum > 1) {
	%>
	<a href="javascript:prePageInfo(<%=pageInfoStartNum - 1%>)"><s:text name="FrontPage"><s:param><%=pageInfoSize%></s:param></s:text>
	</a>
	<%
	    } else {
	%>
	<span class="disabled_tnt_pagination"><s:text name="FrontPage"><s:param><%=pageInfoSize%></s:param></s:text>
	</span>
	<%
	    }
	%>
