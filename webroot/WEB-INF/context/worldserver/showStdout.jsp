...
// 		 var worldId = $("input[name=worldId]");
//          $.ajax({
//              type: "POST",
//              data : {
//  				"worldId" : worldId,
//  			},
//              url: "worldserver/showStdout.action",
//          });
	});
	 var P = window.parent, E = P.loadinndlg();
	    function closreload(url)
	    {
	    	...
	    	//    P.reload(D.J.dialog.infrm['newForm'],ctx+"/operateLog/operatingLogList.action",true);
	         ...
	         E.location.href=ctx+"/worldserver/worldServerList.action"; //此句为关闭此子窗口同时父窗口跳转到  ListData.aspx 页面
	         P.cancel();
	    }
</script>
</head>
	...
	<div class="row-fluid">
		<div class="block">
			<form id="listForm" action="worldserver/list.action" method="post">
				...
				<input type="hidden" value="${worldId }" name="worldId">
